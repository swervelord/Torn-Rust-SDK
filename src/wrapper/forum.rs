...
use crate::models::manual::forum::{
    ForumCategoriesBundle, ForumLookupBundle, ForumPostsBundle, ForumThreadBundle,
    ForumThreadsBundle, ForumTimestampBundle,
};
...
pub struct ForumOptions {
    ...
    /// Optional category id list for category-scoped `threads`.
...
impl<T: HttpTransport> ForumApi<'_, T> {
    ...
    /// Typed helper for `forum.categories`.
    pub async fn categories(
        &self,
        options: ForumOptions,
    ) -> Result<ForumCategoriesBundle, SdkError> {
        validate_options_for_selection("categories", &options)?;
        execute_typed(
            self.client,
            "forum",
    ...
    /// Typed helper for `forum.lookup`.
    pub async fn lookup(&self, options: ForumOptions) -> Result<ForumLookupBundle, SdkError> {
    ...
    /// Typed helper for `forum.threads`.
    pub async fn threads(&self, options: ForumOptions) -> Result<ForumThreadsBundle, SdkError> {
        validate_options_for_selection("threads", &options)?;
        execute_typed(
            self.client,
            "forum",
    ...
    /// Typed helper for `forum.posts`.
    pub async fn posts(&self, options: ForumOptions) -> Result<ForumPostsBundle, SdkError> {
        validate_options_for_selection("posts", &options)?;
        execute_typed(
            self.client,
            "forum",
            vec!["posts".to_string()],
    ...
    /// Typed helper for `forum.timestamp`.
    pub async fn timestamp(&self, options: ForumOptions) -> Result<ForumTimestampBundle, SdkError> {
