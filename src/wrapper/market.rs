...
use crate::models::manual::market::{
    MarketAuctionHouseBundle, MarketAuctionHouseListingBundle, MarketBazaarBundle,
    MarketItemMarketBundle, MarketLookupBundle, MarketPointsMarketBundle, MarketPropertiesBundle,
    MarketRentalsBundle, MarketTimestampBundle,
};
...
impl<T: HttpTransport> MarketApi<'_, T> {
    ...
    /// Typed helper for `market.lookup`.
    pub async fn lookup(&self, options: MarketOptions) -> Result<MarketLookupBundle, SdkError> {
    ...
    /// Typed helper for `market.timestamp`.
    pub async fn timestamp(
        &self,
        options: MarketOptions,
    ) -> Result<MarketTimestampBundle, SdkError> {
    ...
    /// Typed helper for `market.pointsmarket`.
    pub async fn pointsmarket(
        &self,
        options: MarketOptions,
    ) -> Result<MarketPointsMarketBundle, SdkError> {
        validate_options_for_selection("pointsmarket", &options)?;
        execute_typed(
            self.client,
            "market",
            vec!["pointsmarket".to_string()],
            options.into_data_request_options(),
        )
        .await
    }

    /// Typed helper for `market.properties`.
    pub async fn properties(
        &self,
        options: MarketOptions,
    ) -> Result<MarketPropertiesBundle, SdkError> {
    ...
    /// Typed helper for `market.rentals`.
    pub async fn rentals(&self, options: MarketOptions) -> Result<MarketRentalsBundle, SdkError> {
        validate_options_for_selection("rentals", &options)?;
        execute_typed(
            self.client,
            "market",
            vec!["rentals".to_string()],
            options.into_data_request_options(),
        )
        .await
    }
    ...
    /// Typed helper for `market.auctionhouse`.
    pub async fn auctionhouse(
        &self,
        options: MarketOptions,
    ) -> Result<MarketAuctionHouseBundle, SdkError> {
        validate_options_for_selection("auctionhouse", &options)?;
        execute_typed(
            self.client,
            "market",
            vec!["auctionhouse".to_string()],
            options.into_data_request_options(),
        )
        .await
    }

    /// Typed helper for `market.auctionhouselisting`.
    pub async fn auctionhouselisting(
        &self,
        options: MarketOptions,
    ) -> Result<MarketAuctionHouseListingBundle, SdkError> {
        validate_options_for_selection("auctionhouselisting", &options)?;
        execute_typed(
            self.client,
            "market",
            vec!["auctionhouselisting".to_string()],
            options.into_data_request_options(),
        )
        .await
    }
...
fn validate_options_for_selection(
    ...
    if matches!(selection, "auctionhouselisting" | "bazaar" | "itemmarket") {
